...
public class EmployeeController {
	...
	public String save(@Valid @ModelAttribute("addemployee")Employee employee,BindingResult br) {
		if(br.hasErrors()) {
			return "addemployee";
		}
	...
	public ModelAndView search(@Param ("emp_id") Long emp_id,@Param ("first_name") String first_name) {
		...
		System.out.println(emp_id);
		 ...
		 if(emp_id!=null) {
			employees= employeeDao.search(emp_id);
		}
		 else if(first_name!=null) {
			 employees= employeeDao.search(first_name);
		...
		String[] nameMapping = {"emp_id", "first_name", "doj", "post_name", "emp_level","mobile_num","email_id","office_mail","dob",
